 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "clouds.com", ownerName = "clouds.com", packagePath="mammatus"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBiYYFjHZP_muxhumsS1XDV81Uniy4tDKM";
